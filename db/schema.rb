...
ActiveRecord::Schema[7.0].define(version: 2022_12_12_080804) do
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.integer "doctor_id"
    t.index ["patient_appointment_id"], name: "index_notifications_on_patient_appointment_id"
  ...
  add_foreign_key "notifications", "patient_appointments"
