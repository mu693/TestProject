...
class AppointmentDatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create appointment_date' do
    assert_difference('AppointmentDate.count') do
      post appointment_dates_url,
           params: { appointment_date: { doctor_id: @appointment_date.doctor_id, end_time: @appointment_date.end_time,
  ...
  test 'should update appointment_date' do
    patch appointment_date_url(@appointment_date),
          params: { appointment_date: { doctor_id: @appointment_date.doctor_id, end_time: @appointment_date.end_time,
                                        start_time: @appointment_date.start_time } }
